...
CREATE TABLE `invoicelineitems` (
  ...
  CONSTRAINT `invoicelineitems_ibfk_1` FOREIGN KEY (`InvoiceID`) REFERENCES `invoices` (`InvoiceID`),
  CONSTRAINT `invoicelineitems_ibfk_2` FOREIGN KEY (`ProductID`) REFERENCES `products` (`ProductID`)
